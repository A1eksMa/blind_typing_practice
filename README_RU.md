...
Для того чтобы запустить Тренажер слепой печати, Вам достаточно скопировать файлы репозитория на свой компьютер и запустить исполняемый скрипт `main.py` с помощью интерпретатора **python** в терминальном режиме.
